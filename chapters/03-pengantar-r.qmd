...
Buku ini akan menggunakan *dataset* yang dikompilasi dari berbagai sumber (lihat Bab [VII](#sec-isu) tentang sumber data) di Indonesia yang menggambarkan situasi *input* dan *output* rumah sakit di Indonesia. Data yang akan digunakan pada buku ini dapat diunduh pada laman [http://ugm.id/hafidzrizalefisiensi](http://ugm.id/hafidzrizalefisiensi){target="_blank" rel="noopener"} dengan nama file “hospital.csv”.
